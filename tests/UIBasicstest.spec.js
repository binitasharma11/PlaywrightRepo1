...
test('uiControls', async({page})=>
{
    ...
    console.log(await radiobutton.nth(0).isChecked()); //.isChecked is not an assertion, it will return the boolean value(T/F). This will just print the returned value in the console.
