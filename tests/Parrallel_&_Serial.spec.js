...
// test.describe.configure({mode:'parallel'}); //This is used to run test parallelly in the same file
test.describe.configure({mode:'serial'}); //This executes the test using only 1 worker in serial manner
